...
func NewSimpleHumanTraits(name string, send_rate, forget_rate, rhythm, send_prop, response float64, next_func func(SimpleHumanTraits) float64, r *rand.Rand) *SimpleHumanTraits {
	return &SimpleHumanTraits{Name: name, SendRate: send_rate, ForgetRate: forget_rate, Rhythm: rhythm, SendProp: send_prop, ResponseProb: response, NextMsgFunc: next_func, randomizer: r}
}
